...
![](docs/SortCharactersOverview.png)
![](docs/SortCharacters.png)
```
...
```
![](docs/EquivalenceClassOverview.png)
![](docs/EquivalenceClassExample.png)
![](docs/EquivalenceClass.png)             
```     
...
## Transition Phase
![](docs/DubCyclicShiftOverview1.png)
![](docs/DubCyclicShiftExample.png)
![](docs/DubCyclicShiftOverview2.png)
![](docs/DubCyclicShiftOverview3.png)
![](docs/DubCyclicShiftOverview4.png)
![](docs/SortDoubled.png)
```
        Count count( 123, 0 ); {
            for( auto i{ 0 }; i < N; ++i ){
                auto cl = eClass[ i ];
